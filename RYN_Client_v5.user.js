...
(function() {
  ...
  class UpdateAngle {
    ...
    postTick() {
      ...
      if (myPlayer) {
        /* Both angles come out of atan2, so they wrap at ±PI: aiming west,
         * 3.10 and -3.10 are 0.08 apart but subtract to 6.20. Comparing the
         * raw difference resent the angle every tick along that seam. Fold it
         * back into (-PI, PI] first — same wrap the cone checks already use. */
        let diff = myPlayer.angle - sendDir;
