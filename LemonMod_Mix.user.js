...
const LEMONMOD_0x5ef9f2 = new Audio(),
  LEMONMOD_0x2adc6d = new Audio(),
  LEMONMOD_0x337fbb = new Audio(),
  LEMONMOD_0x1bab5a = new Audio(),
  LEMONMOD_0x1bbeae = new Audio();
    ...
    if (_0x3177fa == 1) {
      ...
      window.LemonMix.onSend(function (LEMONMIX_NAME, LEMONMIX_ARGS) {
        ...
        if (_0x200659[0] == "ch") {
          ...
          if (_0x59710e == "!km" || _0x59710e == "?km") {
            setTimeout(() => {
              LEMONMOD_0x262fc1.create("Katana + Musket", "You have automatically equipped the Katana Musket setup.", "", "fadeInRight", 2);
            }, 500);
            _0x1a71b1();
          }
          if (_0x59710e == "!pm" || _0x59710e == "?pm") {
            setTimeout(() => {
              LEMONMOD_0x262fc1.create("Polearm + Musket", "You have automatically equipped the Polearm Musket setup.", "", "fadeInRight", 2);
            }, 500);
          ...
          if (_0x59710e == "!sh" || _0x59710e == "?sh") {
            setTimeout(() => {
              LEMONMOD_0x262fc1.create("Stick + Hammer", "You have automatically equipped the Stick Hammer setup.", "", "fadeInRight", 2);
            }, 500);
              ...
              if ($("#instaType").val() == "oneframe") {
                ...
                if (document.getElementById("autoInstaBullCheck").checked) {
                  if (LEMONMOD_0x509e10 != 6) {
                    ...
                    LEMONMOD_0x262fc1.create("Auto Insta", "Auto Instakill has been triggered. You have automatically targeted the nearest player.", "", "fadeInRight", 2);
                    _0x582132();
                  } else {
                    if (document.getElementById("autoInsta").checked || _0x1cc8bf) {
                      _0x35285a(["2", [_0x458628]]);
      ...
      function _0x18eeae(_0x60679e) {
        ...
        if (_0x57bb3c) switch (_0x2be80f) {
              ...
              if (_0x2a69ad[6] == 15 && _0x2a69ad[7] != LEMONMOD_0x388eda.clan && _0x2a69ad[7] != LEMONMOD_0x388eda.id) {
                if (Math.sqrt(Math.pow(LEMONMOD_0x388eda.y - _0x2a69ad[2], 2) + Math.pow(LEMONMOD_0x388eda.x - _0x2a69ad[1], 2)) < 100) {
                  if (document.getElementById("antiTrap").checked) {
                    ...
                    LEMONMOD_0x262fc1.create("AntiTrap", "You have been trapped. The trap will be broken automatically.", "", "fadeInRight", 2);
                    if (LEMONMOD_0x3f2908.length >= 4) {
                      _0xfc5fd(22);
                      _0x10e170(21, !![]);
                    } else {
          ...
          case "11":
            ...
            LEMONMOD_0x262fc1.create("You Died", "You have been killed.", "", "fadeInRight", 2);
            _0x3d1f00 = ![];
            _0x967ac = [];
      ...
      document.addEventListener("keydown", function (_0x40a833) {
        ...
        if (_0x40a833.keyCode == 188 && !LEMONMOD_0x35bf68.includes(document.activeElement.id.toLowerCase())) {
          ...
          if (_0xe2efd2 == 1) {
            LEMONMOD_0x262fc1.create("AutoMill: ON", "AutoMill has been enabled.", "", "fadeInRight", 2);
          } else {
            LEMONMOD_0x262fc1.create("AutoMill: OFF", "AutoMill has been disabled.", "", "fadeInRight", 2);
          }
        }
        ;
        ...
        if (_0x40a833.keyCode == 69 && !LEMONMOD_0x35bf68.includes(document.activeElement.id.toLowerCase())) {
          ...
          if (LEMONMOD_0x5c6332) {
            LEMONMOD_0x262fc1.create("AutoHit: ON", "AutoHit has been enabled.", "", "fadeInRight", 2);
          } else {
            LEMONMOD_0x262fc1.create("AutoHit: OFF", "AutoHit has been disabled.", "", "fadeInRight", 2);
          }
        }
        ;
        if (_0x40a833.keyCode == 88 && !LEMONMOD_0x35bf68.includes(document.activeElement.id.toLowerCase())) {
          ...
          if (LEMONMOD_0x228025) {
            LEMONMOD_0x262fc1.create("AimLock: ON", "AimLock has been enabled.", "", "fadeInRight", 2);
          } else {
            LEMONMOD_0x262fc1.create("AimLock: OFF", "AimLock has been disabled.", "", "fadeInRight", 2);
          }
        }
        ;
        if (_0x40a833.keyCode == 73 && !LEMONMOD_0x35bf68.includes(document.activeElement.id.toLowerCase())) {
          _0x1945c1 = !_0x1945c1;
          if (_0x1945c1) {
            LEMONMOD_0x262fc1.create("EMP Mode: ON", "EMP Mode has been enabled.", "", "fadeInRight", 2);
          } else {
            LEMONMOD_0x262fc1.create("EMP Mode: OFF", "EMP Mode has been disabled.", "", "fadeInRight", 2);
          }
          ;
        }
