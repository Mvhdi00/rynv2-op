...
LemonMix._Visuals = {
  ...
  _weaponSpeed(index) {
    const w = LemonMix.Weapons[index];
  ...
  _targetRing(ctx, player, xOffset, yOffset) {
    try {
      ...
      if (!this._ringImage) {
        ...
        this._ringImage.src = LemonMix.RingSprite;
      }
...
const LEMONMOD_0x3bee5e = "";
const LEMONMOD_0x5ef9f2 = new Audio("menu_music.mp3"),
  LEMONMOD_0x2adc6d = new Audio("in_snow.mp3"),
  LEMONMOD_0x337fbb = new Audio("in_plains.mp3"),
  LEMONMOD_0x1bab5a = new Audio("in_desert.mp3"),
  LEMONMOD_0x1bbeae = new Audio("in_river.mp3");
...
function LEMONMOD_0x1a6d4a(_0x32d664, _0x48da9d = 0) {
  if (LEMONMOD_0x15fe57) {
    ...
    if (!LEMONMOD_0x1ccd2a[_0x2bda1f]) {
      LEMONMOD_0x1ccd2a[_0x2bda1f] = new Audio("" + _0x32d664 + ".mp3");
...
setTimeout(() => {
  ...
  try {
    ...
    _0xc78e4e.id = "newScoreDisplay", _0x229907.after(_0xc78e4e), window.location.native_resolution = !![], $("#newScoreDisplay").css({
      ...
      "background-image": "url(\"insta_ico.png\")",
      "color": "#ffffff"
    }), $("#shameDisplay").css({
      "background-color": "rgba(0, 0, 0, 0.25)",
      "-webkit-border-radius": "4px",
      ...
      "background-repeat": "no-repeat",
      "background-position": "left 6px center",
      "background-image": "url(\"clown_ico.png\")",
      "color": "#ffffff"
    }), $("#foodDisplay").css({
      "color": "#ae4d54"
    }), $("#woodDisplay").css({
  ...
  if ($("#gameCanvas").css("cursor", "default"), LEMONMOD_0x211e6c) console.log("custom cursor loaded with jQuery");
  ...
  var _0x56df68 = setInterval(() => {
    if (_0x3177fa == 1) {
      ...
      var _0x48275e = 0;
      var _0x17f868 = 0;
      var _0x22659b = new Audio("kill.mp3");
      ...
      window.LemonMix.onSend(function (LEMONMIX_NAME, LEMONMIX_ARGS) {
        ...
        if (_0x200659[0] == "ch") {
          ...
          if (_0x59710e == "!km" || _0x59710e == "?km") {
            setTimeout(() => {
              LEMONMOD_0x262fc1.create("Katana + Musket", "You have automatically equipped the Katana Musket setup.", "Katana.png", "fadeInRight", 2);
            }, 500);
            _0x1a71b1();
          }
          if (_0x59710e == "!pm" || _0x59710e == "?pm") {
            setTimeout(() => {
              LEMONMOD_0x262fc1.create("Polearm + Musket", "You have automatically equipped the Polearm Musket setup.", "Polearm.png", "fadeInRight", 2);
            }, 500);
          ...
          if (_0x59710e == "!sh" || _0x59710e == "?sh") {
            setTimeout(() => {
              LEMONMOD_0x262fc1.create("Stick + Hammer", "You have automatically equipped the Stick Hammer setup.", "hammer.png", "fadeInRight", 2);
            }, 500);
              ...
              if ($("#instaType").val() == "oneframe") {
                ...
                if (document.getElementById("autoInstaBullCheck").checked) {
                  if (LEMONMOD_0x509e10 != 6) {
                    ...
                    LEMONMOD_0x262fc1.create("Auto Insta", "Auto Instakill has been triggered. You have automatically targeted the nearest player.", "insta_ico.png", "fadeInRight", 2);
                    _0x582132();
                  } else {
                    if (document.getElementById("autoInsta").checked || _0x1cc8bf) {
                      _0x35285a(["2", [_0x458628]]);
      ...
      function _0x18eeae(_0x60679e) {
        ...
        if (_0x57bb3c) switch (_0x2be80f) {
              ...
              if (_0x2a69ad[6] == 15 && _0x2a69ad[7] != LEMONMOD_0x388eda.clan && _0x2a69ad[7] != LEMONMOD_0x388eda.id) {
                if (Math.sqrt(Math.pow(LEMONMOD_0x388eda.y - _0x2a69ad[2], 2) + Math.pow(LEMONMOD_0x388eda.x - _0x2a69ad[1], 2)) < 100) {
                  if (document.getElementById("antiTrap").checked) {
                    ...
                    LEMONMOD_0x262fc1.create("AntiTrap", "You have been trapped. The trap will be broken automatically.", "Trap.png", "fadeInRight", 2);
                    if (LEMONMOD_0x3f2908.length >= 4) {
                      _0xfc5fd(22);
                      _0x10e170(21, !![]);
                    } else {
          ...
          case "11":
            ...
            LEMONMOD_0x262fc1.create("You Died", "You have been killed.", "Skull.png", "fadeInRight", 2);
            _0x3d1f00 = ![];
            _0x967ac = [];
          ...
          for (let _0x43c016 of _0x5d9f53.servers) {
            ...
            if (_0x5693e7 == _0x35cc56) {
              if (LEMONMOD_0x851673[0]) {
                ...
                if (_0x31f0ab) {
                  window.LemonMix.Bot.tokenPromise().then(function (_0x485ba4) {
                    _0x31751f(_0x366445 + "&token=" + encodeURIComponent(_0x485ba4), _0x154413 + " " + _0x35cc56);
                  });
                }
              } else {
                window.LemonMix.Bot.tokenPromise().then(function (_0x3639bd) {
          ...
          for (let _0x2c8236 of _0x4ac3bd.servers) {
            ...
            if (_0x2c8236.games[0].playerCount < 40) {
              if (LEMONMOD_0x851673[0]) {
                ...
                if (_0x25f910) {
                  window.LemonMix.Bot.tokenPromise().then(function (_0x390edc) {
                    _0x31751f(_0x329f1b + "&token=" + encodeURIComponent(_0x390edc), "sandbox.moomoo.io " + _0x3fc7d);
                  });
                }
              } else {
                window.LemonMix.Bot.tokenPromise().then(function (_0x37c78b) {
          ...
          for (let _0x3c8faf of _0x1b9e82.servers) {
            ...
            if (_0x3c8faf.games[0].playerCount < 40) {
              if (LEMONMOD_0x851673[0]) {
                ...
                if (_0x1ec9d2) {
                  window.LemonMix.Bot.tokenPromise().then(function (_0x3027bc) {
                    _0x31751f(_0x41ab81 + "&token=" + encodeURIComponent(_0x3027bc), "moomoo.io " + _0x23ed9e);
                  });
                }
              } else {
                window.LemonMix.Bot.tokenPromise().then(function (_0x51e8d5) {
          ...
          for (let _0x5eded4 of _0x53c229.servers) {
            ...
            if (_0x5eded4.games[0].playerCount < 40) {
              if (LEMONMOD_0x851673[0]) {
                ...
                if (_0x14072f) {
                  window.LemonMix.Bot.tokenPromise().then(function (_0x1ef631) {
                    _0x31751f(_0x510b69 + "&token=" + encodeURIComponent(_0x1ef631), "dev.moomoo.io " + _0x2a331e);
                  });
                }
              } else {
                window.LemonMix.Bot.tokenPromise().then(function (_0x2716c4) {
      ...
      document.addEventListener("keydown", function (_0x40a833) {
        ...
        if (_0x40a833.keyCode == 188 && !LEMONMOD_0x35bf68.includes(document.activeElement.id.toLowerCase())) {
          ...
          if (_0xe2efd2 == 1) {
            LEMONMOD_0x262fc1.create("AutoMill: ON", "AutoMill has been enabled.", "Windmill.png", "fadeInRight", 2);
          } else {
            LEMONMOD_0x262fc1.create("AutoMill: OFF", "AutoMill has been disabled.", "Windmill.png", "fadeInRight", 2);
          }
        }
        ;
        ...
        if (_0x40a833.keyCode == 69 && !LEMONMOD_0x35bf68.includes(document.activeElement.id.toLowerCase())) {
          ...
          if (LEMONMOD_0x5c6332) {
            LEMONMOD_0x262fc1.create("AutoHit: ON", "AutoHit has been enabled.", "Sword.png", "fadeInRight", 2);
          } else {
            LEMONMOD_0x262fc1.create("AutoHit: OFF", "AutoHit has been disabled.", "Sword.png", "fadeInRight", 2);
          }
        }
        ;
        if (_0x40a833.keyCode == 88 && !LEMONMOD_0x35bf68.includes(document.activeElement.id.toLowerCase())) {
          ...
          if (LEMONMOD_0x228025) {
            LEMONMOD_0x262fc1.create("AimLock: ON", "AimLock has been enabled.", "Aim.png", "fadeInRight", 2);
          } else {
            LEMONMOD_0x262fc1.create("AimLock: OFF", "AimLock has been disabled.", "Aim.png", "fadeInRight", 2);
          }
        }
        ;
        if (_0x40a833.keyCode == 73 && !LEMONMOD_0x35bf68.includes(document.activeElement.id.toLowerCase())) {
          _0x1945c1 = !_0x1945c1;
          if (_0x1945c1) {
            LEMONMOD_0x262fc1.create("EMP Mode: ON", "EMP Mode has been enabled.", "Emp.png", "fadeInRight", 2);
          } else {
            LEMONMOD_0x262fc1.create("EMP Mode: OFF", "EMP Mode has been disabled.", "Emp.png", "fadeInRight", 2);
          }
          ;
        }
