...
node tests/clan.test.js        # 35 assertions: clan rotation, HUD, Be Angel vs cowboy, heal timing
```
...
`src/RYN_Client_v5.3.js` is the unmodified v5.3 client. The script applies 76
