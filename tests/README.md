...
node tests/botcombat.test.js   # 57 assertions: auto break, kiting, shields, train, counter, Be Angel
```
...
`src/RYN_Client_v5.3.js` is the unmodified v5.3 client. The script applies 59
