...
let R = CanvasRenderingContext2D.prototype.rotate,
	e = {
		...
		/* The numeric keys, the decoy Math.min/Math.max call and the base64
		 * were all cover for one line: key 31 returned
		 * https://ksw2-center.glitch.me/mm_aib_1 and key 9012 fetched it, with
		 * init() at the bottom firing it on load. The rotate guard it was
		 * wrapped around is real and stays; the beacon is removed. */
